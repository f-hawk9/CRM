...
<div class="modal-dialog modal-sm" style="margin-top: 10%;">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <div class="form-group">
                <input id="submit" type="submit" class="btn btn-primary form-control" value="登录">
                <br />
                <br />
                <button type="button" class="btn btn-primary form-control" id="add" onclick="registMehod()">注册</button>
            </div>
        </div>
        </form>
    </div><!-- /.modal-content -->
